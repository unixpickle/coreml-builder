...
public struct Int64Parameter {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Int64Parameter.OneOf_AllowedValues, rhs: Int64Parameter.OneOf_AllowedValues) -> Bool {
...
public struct DoubleParameter {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: DoubleParameter.OneOf_AllowedValues, rhs: DoubleParameter.OneOf_AllowedValues) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension Int64Parameter: @unchecked Sendable {}
extension Int64Parameter.OneOf_AllowedValues: @unchecked Sendable {}
extension DoubleParameter: @unchecked Sendable {}
extension DoubleParameter.OneOf_AllowedValues: @unchecked Sendable {}
extension StringParameter: @unchecked Sendable {}
extension BoolParameter: @unchecked Sendable {}
