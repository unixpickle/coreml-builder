...
extension Normalizer.NormType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Normalizer.NormType] = [
    .lmax,
    .l1,
    .l2,
  ]
...
extension Normalizer: @unchecked Sendable {}
extension Normalizer.NormType: @unchecked Sendable {}
