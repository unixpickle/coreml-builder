...
public struct PipelineClassifier {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct PipelineRegressor {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Model {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Model.OneOf_Type, rhs: Model.OneOf_Type) -> Bool {
      ...
      case (.classConfidenceThresholding, .classConfidenceThresholding): return {
        guard case .classConfidenceThresholding(let l) = lhs, case .classConfidenceThresholding(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
extension PipelineClassifier: @unchecked Sendable {}
extension PipelineRegressor: @unchecked Sendable {}
extension FeatureDescription: @unchecked Sendable {}
extension Metadata: @unchecked Sendable {}
extension FunctionDescription: @unchecked Sendable {}
extension ModelDescription: @unchecked Sendable {}
extension SerializedModel: @unchecked Sendable {}
extension Model: @unchecked Sendable {}
extension Model.OneOf_Type: @unchecked Sendable {}
