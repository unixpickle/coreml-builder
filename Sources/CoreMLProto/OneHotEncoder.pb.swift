...
public struct OneHotEncoder {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: OneHotEncoder.OneOf_CategoryType, rhs: OneHotEncoder.OneOf_CategoryType) -> Bool {
...
extension OneHotEncoder.HandleUnknown: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [OneHotEncoder.HandleUnknown] = [
    .errorOnUnknown,
    .ignoreUnknown,
  ]
}
...
extension OneHotEncoder: @unchecked Sendable {}
extension OneHotEncoder.OneOf_CategoryType: @unchecked Sendable {}
extension OneHotEncoder.HandleUnknown: @unchecked Sendable {}
