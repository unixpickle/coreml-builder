...
public struct CoreMLModels_SoundAnalysisPreprocessing {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: CoreMLModels_SoundAnalysisPreprocessing.OneOf_SoundAnalysisPreprocessingType, rhs: CoreMLModels_SoundAnalysisPreprocessing.OneOf_SoundAnalysisPreprocessingType) -> Bool {
...
extension CoreMLModels_SoundAnalysisPreprocessing: @unchecked Sendable {}
extension CoreMLModels_SoundAnalysisPreprocessing.OneOf_SoundAnalysisPreprocessingType: @unchecked Sendable {}
extension CoreMLModels_SoundAnalysisPreprocessing.Vggish: @unchecked Sendable {}
