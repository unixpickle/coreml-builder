...
public struct Imputer {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Imputer.OneOf_ImputedValue, rhs: Imputer.OneOf_ImputedValue) -> Bool {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Imputer.OneOf_ReplaceValue, rhs: Imputer.OneOf_ReplaceValue) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension Imputer: @unchecked Sendable {}
extension Imputer.OneOf_ImputedValue: @unchecked Sendable {}
extension Imputer.OneOf_ReplaceValue: @unchecked Sendable {}
