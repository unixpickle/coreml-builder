...
public struct GLMClassifier: Sendable {
  ...
  public enum PostEvaluationTransform: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [GLMClassifier.PostEvaluationTransform] = [
      .logit,
      .probit,
    ]
  ...
  public enum ClassEncoding: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [GLMClassifier.ClassEncoding] = [
      .referenceClass,
      .oneVsRest,
    ]
