...
public struct CustomModel {
  ...
  public var parameters: Dictionary<String,CustomModel.CustomModelParamValue> = [:]
  ...
  public struct CustomModelParamValue {
    ...
    public var value: CustomModel.CustomModelParamValue.OneOf_Value? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: CustomModel.CustomModelParamValue.OneOf_Value, rhs: CustomModel.CustomModelParamValue.OneOf_Value) -> Bool {
...
extension CustomModel: @unchecked Sendable {}
extension CustomModel.CustomModelParamValue: @unchecked Sendable {}
extension CustomModel.CustomModelParamValue.OneOf_Value: @unchecked Sendable {}
...
extension CustomModel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 30: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,CustomModel.CustomModelParamValue>.self, value: &self.parameters) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.parameters.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,CustomModel.CustomModelParamValue>.self, value: self.parameters, fieldNumber: 30)
    }
  ...
  public static func ==(lhs: CustomModel, rhs: CustomModel) -> Bool {
...
extension CustomModel.CustomModelParamValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = CustomModel.protoMessageName + ".CustomModelParamValue"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: CustomModel.CustomModelParamValue, rhs: CustomModel.CustomModelParamValue) -> Bool {
