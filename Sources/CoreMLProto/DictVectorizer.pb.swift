...
public struct DictVectorizer {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var map: DictVectorizer.OneOf_Map? = nil

  /// String keys to indexes
  public var stringToIndex: StringVector {
    get {
  ...
  /// Int keys to indexes
  public var int64ToIndex: Int64Vector {
    get {
  ...
  public enum OneOf_Map: Equatable {
    /// String keys to indexes
    case stringToIndex(StringVector)
    /// Int keys to indexes
    case int64ToIndex(Int64Vector)

  #if !swift(>=4.1)
    public static func ==(lhs: DictVectorizer.OneOf_Map, rhs: DictVectorizer.OneOf_Map) -> Bool {
...
extension DictVectorizer: @unchecked Sendable {}
extension DictVectorizer.OneOf_Map: @unchecked Sendable {}
...
extension DictVectorizer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: DictVectorizer, rhs: DictVectorizer) -> Bool {
