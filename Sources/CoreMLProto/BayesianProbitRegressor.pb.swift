...
public struct BayesianProbitRegressor {
  ...
  /// bias term
  public var bias: BayesianProbitRegressor.Gaussian {
    get {return _bias ?? BayesianProbitRegressor.Gaussian()}
    set {_bias = newValue}
  }
  ...
  public var features: [BayesianProbitRegressor.FeatureWeight] = []
  ...
  public struct FeatureValueWeight {
    ...
    public var featureWeight: BayesianProbitRegressor.Gaussian {
      get {return _featureWeight ?? BayesianProbitRegressor.Gaussian()}
    ...
    fileprivate var _featureWeight: BayesianProbitRegressor.Gaussian? = nil
  }
  ...
  public struct FeatureWeight {
    ...
    public var weights: [BayesianProbitRegressor.FeatureValueWeight] = []
  ...
  fileprivate var _bias: BayesianProbitRegressor.Gaussian? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension BayesianProbitRegressor: @unchecked Sendable {}
extension BayesianProbitRegressor.Gaussian: @unchecked Sendable {}
extension BayesianProbitRegressor.FeatureValueWeight: @unchecked Sendable {}
extension BayesianProbitRegressor.FeatureWeight: @unchecked Sendable {}
...
extension BayesianProbitRegressor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: BayesianProbitRegressor, rhs: BayesianProbitRegressor) -> Bool {
...
extension BayesianProbitRegressor.Gaussian: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BayesianProbitRegressor.protoMessageName + ".Gaussian"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "mean"),
  ...
  public static func ==(lhs: BayesianProbitRegressor.Gaussian, rhs: BayesianProbitRegressor.Gaussian) -> Bool {
...
extension BayesianProbitRegressor.FeatureValueWeight: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BayesianProbitRegressor.protoMessageName + ".FeatureValueWeight"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: BayesianProbitRegressor.FeatureValueWeight, rhs: BayesianProbitRegressor.FeatureValueWeight) -> Bool {
...
extension BayesianProbitRegressor.FeatureWeight: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BayesianProbitRegressor.protoMessageName + ".FeatureWeight"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: BayesianProbitRegressor.FeatureWeight, rhs: BayesianProbitRegressor.FeatureWeight) -> Bool {
