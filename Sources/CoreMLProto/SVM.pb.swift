...
public struct Kernel {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Kernel.OneOf_Kernel, rhs: Kernel.OneOf_Kernel) -> Bool {
...
public struct SparseSupportVectors {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct DenseSupportVectors {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SupportVectorRegressor {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: SupportVectorRegressor.OneOf_SupportVectors, rhs: SupportVectorRegressor.OneOf_SupportVectors) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct SupportVectorClassifier {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: SupportVectorClassifier.OneOf_SupportVectors, rhs: SupportVectorClassifier.OneOf_SupportVectors) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: SupportVectorClassifier.OneOf_ClassLabels, rhs: SupportVectorClassifier.OneOf_ClassLabels) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension LinearKernel: @unchecked Sendable {}
extension RBFKernel: @unchecked Sendable {}
extension PolyKernel: @unchecked Sendable {}
extension SigmoidKernel: @unchecked Sendable {}
extension Kernel: @unchecked Sendable {}
extension Kernel.OneOf_Kernel: @unchecked Sendable {}
extension SparseNode: @unchecked Sendable {}
extension SparseVector: @unchecked Sendable {}
extension SparseSupportVectors: @unchecked Sendable {}
extension DenseVector: @unchecked Sendable {}
extension DenseSupportVectors: @unchecked Sendable {}
extension Coefficients: @unchecked Sendable {}
extension SupportVectorRegressor: @unchecked Sendable {}
extension SupportVectorRegressor.OneOf_SupportVectors: @unchecked Sendable {}
extension SupportVectorClassifier: @unchecked Sendable {}
extension SupportVectorClassifier.OneOf_SupportVectors: @unchecked Sendable {}
extension SupportVectorClassifier.OneOf_ClassLabels: @unchecked Sendable {}
