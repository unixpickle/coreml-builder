...
public struct CoreMLModels_Gazetteer {
  ...
  public var classLabels: CoreMLModels_Gazetteer.OneOf_ClassLabels? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: CoreMLModels_Gazetteer.OneOf_ClassLabels, rhs: CoreMLModels_Gazetteer.OneOf_ClassLabels) -> Bool {
...
extension CoreMLModels_Gazetteer: @unchecked Sendable {}
extension CoreMLModels_Gazetteer.OneOf_ClassLabels: @unchecked Sendable {}
...
extension CoreMLModels_Gazetteer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: CoreMLModels_Gazetteer, rhs: CoreMLModels_Gazetteer) -> Bool {
