...
/// label for the input.
public struct CoreMLModels_TextClassifier {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: CoreMLModels_TextClassifier.OneOf_ClassLabels, rhs: CoreMLModels_TextClassifier.OneOf_ClassLabels) -> Bool {
...
extension CoreMLModels_TextClassifier: @unchecked Sendable {}
extension CoreMLModels_TextClassifier.OneOf_ClassLabels: @unchecked Sendable {}
