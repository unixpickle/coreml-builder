...
public struct CategoricalMapping {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: CategoricalMapping.OneOf_MappingType, rhs: CategoricalMapping.OneOf_MappingType) -> Bool {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: CategoricalMapping.OneOf_ValueOnUnknown, rhs: CategoricalMapping.OneOf_ValueOnUnknown) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension CategoricalMapping: @unchecked Sendable {}
extension CategoricalMapping.OneOf_MappingType: @unchecked Sendable {}
extension CategoricalMapping.OneOf_ValueOnUnknown: @unchecked Sendable {}
