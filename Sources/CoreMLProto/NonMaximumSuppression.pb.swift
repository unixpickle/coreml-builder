...
/// discarded.
public struct NonMaximumSuppression {
  ...
  public var suppressionMethod: NonMaximumSuppression.OneOf_SuppressionMethod? = nil

  public var pickTop: NonMaximumSuppression.PickTop {
    get {
      if case .pickTop(let v)? = suppressionMethod {return v}
      return NonMaximumSuppression.PickTop()
    }
  ...
  public var classLabels: NonMaximumSuppression.OneOf_ClassLabels? = nil
  ...
  public enum OneOf_SuppressionMethod: Equatable {
    case pickTop(NonMaximumSuppression.PickTop)

  #if !swift(>=4.1)
    public static func ==(lhs: NonMaximumSuppression.OneOf_SuppressionMethod, rhs: NonMaximumSuppression.OneOf_SuppressionMethod) -> Bool {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: NonMaximumSuppression.OneOf_ClassLabels, rhs: NonMaximumSuppression.OneOf_ClassLabels) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension NonMaximumSuppression: @unchecked Sendable {}
extension NonMaximumSuppression.OneOf_SuppressionMethod: @unchecked Sendable {}
extension NonMaximumSuppression.OneOf_ClassLabels: @unchecked Sendable {}
extension NonMaximumSuppression.PickTop: @unchecked Sendable {}
...
extension NonMaximumSuppression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: NonMaximumSuppression.PickTop?
  ...
  public static func ==(lhs: NonMaximumSuppression, rhs: NonMaximumSuppression) -> Bool {
...
extension NonMaximumSuppression.PickTop: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = NonMaximumSuppression.protoMessageName + ".PickTop"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: NonMaximumSuppression.PickTop, rhs: NonMaximumSuppression.PickTop) -> Bool {
