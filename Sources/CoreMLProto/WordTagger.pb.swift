...
public struct CoreMLModels_WordTagger {
  ...
  public var tags: CoreMLModels_WordTagger.OneOf_Tags? = nil

  public var stringTags: StringVector {
    get {
  ...
  public enum OneOf_Tags: Equatable {
    case stringTags(StringVector)

  #if !swift(>=4.1)
    public static func ==(lhs: CoreMLModels_WordTagger.OneOf_Tags, rhs: CoreMLModels_WordTagger.OneOf_Tags) -> Bool {
...
extension CoreMLModels_WordTagger: @unchecked Sendable {}
extension CoreMLModels_WordTagger.OneOf_Tags: @unchecked Sendable {}
...
extension CoreMLModels_WordTagger: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: CoreMLModels_WordTagger, rhs: CoreMLModels_WordTagger) -> Bool {
